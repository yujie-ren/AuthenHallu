...
def verify(user_query, model_answer, model_name, tokenizer, model):
    ...
    "Your task is to detect if the answer given to the user prompt is a hallucination.\n"
...
if __name__ == '__main__':
    ...
    ###################################################
    # Load the dataset (400 conversations)
    ###################################################
    json_file = ""  # Output file for saving the processed summaries
    ...
    for entry in data:
        ...
        if user_prompt_1:
            ...
            verification_result_1 = verify(user_prompt_1, model_answer_1, model_name, tokenizer, model)
        else:
        ...
        if user_prompt_2:
            ...
            verification_result_2 = verify(user_prompt_2, model_answer_2, model_name, tokenizer, model)
        else:
    ...
    with open(f"results_{model_name}_subset_v2.json", "w", encoding="utf-8") as file:
